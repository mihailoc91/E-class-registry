    ...
    <body class='kiki'>
        ...
        <div>
            <ul class="mes">
                <c:forEach items="${allChats}" var="chat">
                    ...
                    <a href="<c:url value="/parent/message?teacher=${chat.teacher.id}" />"> 
                        <li>
                            <p>To: ${chat.teacher.firstName} ${chat.teacher.lastName}</p>
        ...
        <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                ...
                <c:forEach items="${allTeachersForMessages}" var="teacher">

                    <a href="<c:url value="/parent/message?teacher=${teacher.id}" />"> ${teacher.firstName} ${teacher.lastName} </a>
