...
public class SubjectController {
     ...
     */
    @PostMapping("/subject")
    public String subjectSave(ModelMap model, @ModelAttribute SubjectDto subjectDto, BindingResult result) {
     ...
     *
     * @param model ModelMap object that carry data to the view
     * @param id String that needs to be converted later to int, 
     * represents the id of subject that needs to be deleted.
