...
public class ClassServiceImpl implements ClassService {
    ...
    /**
     * Saves a class in database with data that were entered by Administrator.
     * If the class don't exits it creates a new one in database or if it exists
     * then it updates it.This method is transactional, if something goes wrong
     * (exception is thrown) then it rollback but if all goes well then it
     * commits.
     *
     * @param classDto object of type ClassDto.class that carry data from UI
